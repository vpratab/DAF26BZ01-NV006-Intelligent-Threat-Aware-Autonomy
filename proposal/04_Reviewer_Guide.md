...
4. Open `evidence/scenario_01_nominal_threat_route/trust_scorecard.json`
...
6. Inspect `evidence/scenario_02_overaggressive_avoidance/timeline.json`
5. Review `core/tests/profile_tests.rs`
